...
public class ProcedimientoService {
	...
	public List<Procedimiento> findByFiltro(String texto) {
		return procedimientoRepository.findByFiltroContainingIgnoreCase(texto);
