...
public class ProcesoRestControllerIT {
	...
	private static String URLSERVICIO	= "/api/procesos/";
	...
	/*
	 * LEER TODOS PROCESOS PACIENTE CONCRETO
	 * 
	 * Comprueba obtener mensaje de estado OK (200)
	 */
	@Test
	public void test2() {
		...
		@SuppressWarnings("rawtypes")
		ResponseEntity<ArrayList> respuesta = restTemplate.exchange(
				crearUrlConPuerto(URLSERVICIO + "paciente/" + DEFAULT_PACIENTE_ID),
				HttpMethod.GET, entidad, ArrayList.class);
