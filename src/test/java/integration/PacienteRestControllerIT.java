...
public class PacienteRestControllerIT {
	...
	private static String URLSERVICIO	= "/api/pacientes/";
	...
	public void test2() {
		...
		ResponseEntity<User> respuesta = restTemplate.exchange(
				crearUrlConPuerto(URLSERVICIO + DEFAULT_PACIENTE_ID),
