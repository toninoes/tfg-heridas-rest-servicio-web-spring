...
public class AdministradorRestControllerIT {
	...
	private static String URLSERVICIO	= "/api/administradores/";
	private static String USERNAME		= "admin@user.es";
	private static String PASSWORD		= "admin";
	
	private static String TOKEN;	// Token de autenticación
	private static long DEFAULT_ADMIN_ID = 1;	// ID del administrador creado por defecto
	...
	public void test2() {
		...
		ResponseEntity<User> respuesta = restTemplate.exchange(
				crearUrlConPuerto(URLSERVICIO + DEFAULT_ADMIN_ID),
	...
	/*
	 * LEER UNO INEXISTENTE: Administrador 1
	 * 
	 * Comprueba que coincidan los campos almacenados.
	 */
	@Test
